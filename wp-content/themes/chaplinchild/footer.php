...
<?php
// this is a copy-paste of the footer.php file of the parent theme, using my name as the theme developer
...
<div class="footer-inner section-inner<?php echo esc_attr( $footer_inner_classes ); ?>">
  ...
  <div class="footer-credits">
    ...
    <p class="theme-credits color-secondary">
      ...
      printf( esc_html_x( 'Theme by %s', 'Translators: $s = name of the theme developer', 'chaplin' ), '<a href="http://refinery29.com">' . esc_html__( 'Grace Monahan', 'chaplin child' ) . '</a>' ); ?>
    </p><!-- .theme-credits -->
